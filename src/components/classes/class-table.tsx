            ...
            classes.map((classItem) => {
              ...
              return (
                <TableRow key={classItem.id}>
                  ...
                  <TableCell>${classItem.tuition}</TableCell>
                  <TableCell>
                    <Badge variant="secondary" className={statusColors[classItem.status as keyof typeof statusColors]}>
                      {classItem.status}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem className="text-destructive" onClick={() => handleDelete(classItem.id)}>
